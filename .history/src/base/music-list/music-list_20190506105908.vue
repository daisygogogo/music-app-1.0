<template>
  <transition name="slide_animation">
    <div class="singer_detail">
      ...
      <ul class="music_list-wrapper" ref="musicListWrapper">
      <scroll class="music_list" v-if="songList.length">
...
export default {
  ...
  mounted(){
    ...
    this.$nextTick(() =>{
      ...
      console.log('topPartHeight' + topPartHeight);
      self.$refs.musicListWrapper.style.top = topPartHeight + 'px'
    })
  },
  components:{
    Scroll
