<template>
  <div class="singer-wrapper">
    ...
    <div class="fiexed_title" v-show="fixedTitle">
      <h1 class="title" :style="{transform:`translateY(${transformY}px)`}">{{fixedTitle}}</h1>
    </div>
...
export default {
  ...
  methods: {
    ...
    onShortCutTouchMove(e) {
      ...
      const delta = ((this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT) | 0; // |0向下取整，获取到当前移动了几个项
    ...
    _getFiexedTitle(index) {
      // 还可以使用计算属性，利用当前的currentIndex来得到title，会是更优雅的写法
