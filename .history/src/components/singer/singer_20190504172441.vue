<template>
  <div class="singer-wrapper">
    <scroll class="singer-scroll" ref="singerScroll" v-if="singers.length" @scroll="scroll">
      <div>
...
export default {
  ...
  methods: {
    ...
    onShortCutTouchMove(e){
      ...
      // this.currentIndex = this.touch.anchorIndex + delta;
  ...
  watch:{
    scrollY(val){
      for(let i=0; i < this.listHeight.length; i++){
        if(i < val && val < i + 1 && i !== this.listHeight.length-1){
          this.currentIndex = i;
        }
      }
    }
